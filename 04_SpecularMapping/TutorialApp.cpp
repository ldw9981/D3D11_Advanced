...
bool TutorialApp::InitScene()
{
	...
	hr = CompileShaderFromFile(L"04_SpecularMapping_VS.hlsl", nullptr, "main", "vs_4_0", &vertexShaderBuffer);
	if (FAILED(hr))
	{
	...
	hr = CompileShaderFromFile(L"04_SpecularMapping_PS.hlsl", nullptr, "main", "ps_4_0", &pixelShaderBuffer);
	if (FAILED(hr))
	{
