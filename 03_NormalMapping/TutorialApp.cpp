...
bool TutorialApp::InitScene()
{
	...
	hr = CompileShaderFromFile(L"03_NormalMapping_VS.hlsl", "main", "vs_4_0", &vertexShaderBuffer);
	if (FAILED(hr))
	{
	...
	hr = CompileShaderFromFile(L"03_NormalMapping_PS.hlsl", "main", "ps_4_0", &pixelShaderBuffer);
	if (FAILED(hr))
	{
