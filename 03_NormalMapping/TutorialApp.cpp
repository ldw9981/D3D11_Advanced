...
bool TutorialApp::InitScene()
{
	...
	hr = CompileShaderFromFile(L"03_NormalMapping_VS.hlsl", nullptr, "main", "vs_4_0", &vertexShaderBuffer);
	if (FAILED(hr))
	{
		hr = D3DReadFileToBlob(L"03_NormalMapping_VS.cso", &vertexShaderBuffer);
	}
	HR_T(hr);
	...
	hr = CompileShaderFromFile(L"03_NormalMapping_PS.hlsl", nullptr, "main", "ps_4_0", &pixelShaderBuffer);
	if (FAILED(hr))
	{
		hr = D3DReadFileToBlob(L"03_NormalMapping_PS.cso", &pixelShaderBuffer);
	}
	HR_T(hr);
